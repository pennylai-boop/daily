...
export const LEGAL_EFFECTIVE_DATE = "2026 年 8 月 25 日";
  ...
  return (
    <div className="space-y-5">
      ...
      <Article title="1. 我們蒐集什麼">
        ...
        <Ul
          items={[
            ...
            "贊助與留言：贊助金額與付款方式、信箱、選填的稱呼與留言；付款成功後的訂單編號。",
      ...
      <Article title="3. 使用目的">
        <Ul
          items={[
            ...
            "處理自願贊助、寄送感謝信，以及收受使用建議並在有需要時回覆。",
            "維護服務安全、排除故障、遵守法令。",
          ]}
        />
        <P>我們不會把你的日記內容賣給第三人，也不會用來投放行為廣告。</P>
      </Article>
      ...
      <Article title="4. 第三方服務">
        <Ul
          items={[
            ...
            "統一金流 PAYUNi：贊助付款。卡號與轉帳資料由金流端處理，不經過本服務伺服器。",
            "Resend（若已設定）：寄送贊助感謝信與使用建議相關郵件。",
      ...
      <Article title="7. Cookie 與類似技術">
        <P>
          本服務以瀏覽器本機儲存運作，可能使用 Cookie 或同等技術以維持登入狀態、外觀偏好與網站功能。這些不是用於跨站追蹤廣告。
        </P>
      </Article>
...
export function TermsOfUseBody() {
  return (
    <div className="space-y-5">
      ...
      <Article title="5. 贊助與使用建議">
        <P>
          贊助為自願支持，並非購買商品或訂閱方案，送出付款後原則上不提供退款。付款由 PAYUNi 處理。使用建議可在未付款的情況下送出；你同意我們為改善服務而閱讀並保存留言。
        </P>
        <P>iOS App 內可能不提供贊助相關畫面，以符合應用程式商店規範。</P>
      </Article>
