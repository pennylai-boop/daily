      ...
      <Article title="4. 第三方服務">
        <Ul
          items={[
            ...
            "統一金流 PAYUNi：贊助、卜卦點數與無廣告訂閱付款（訂閱為信用卡每月自動續約）。卡號與轉帳資料由金流端處理，不經過本服務伺服器。",
    ...
    <div className="space-y-5">
      ...
      <Article title="5. 贊助、無廣告訂閱與使用建議">
        <P>
          ...
          元的付費方案，以信用卡定期定額自動續約；每期扣款成功後效期往後加 30
          天，並開立電子發票。原則上不提供退款。如需取消續約，請透過「支持」頁留言，我們會協助停止下一期扣款。付款由
